<template>
  <section class=" xl:px-20 px-4 pt-10 pb-14 w-full bg-white">
    <h3 class="lg:text-[2.125rem] text-2xl mb-8 font-medium">
      {{ $t("labels.gallaryEvent") }}
    </h3>

    <swiper v-if="props.gallary && props.gallary.length" :modules="modules" class="reviewsToursSwiper "
