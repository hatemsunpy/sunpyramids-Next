...
- Sprint 7 again has no staging URLs or dashboard access. Do not add hardcoded metadata, create `/en` routes, add Arabic routes, or hardcode custom marketing sitemap slugs without explicit approval.
